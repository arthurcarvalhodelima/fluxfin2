...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Erro ao buscar rubrica' }, { status: 500 })
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Erro ao atualizar rubrica' }, { status: 500 })
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Erro ao excluir rubrica' }, { status: 500 })
  }
}
