...
const navItems = [
  ...
  { href: "/despesas", label: "Despesas", icon: "M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" },
    ...
    <aside className="w-64 bg-secondary text-white flex flex-col h-screen fixed left-0 top-0 z-40">
      ...
      <nav className="flex-1 p-4 space-y-1">
        {navItems
          ...
          .filter((item) => item.href !== "/despesas" || session?.user?.papelSistema === "ADMIN")
          .map((item) => {
